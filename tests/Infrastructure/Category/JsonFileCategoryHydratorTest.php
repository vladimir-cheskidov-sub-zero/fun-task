...
final class JsonFileCategoryHydratorTest extends TestCase
{
    ...
    {
        $hydrator = new JsonFileCategoryHydrator();
        $category = $hydrator->hydrate(__DIR__ . '/../../../data/categories.json');
    ...
    public function testHydrateRejectsMissingFile(): void
    {
        ...
        (new JsonFileCategoryHydrator())->hydrate(__DIR__ . '/fixtures/missing.json');
    }
    public function testHydrateRejectsInvalidJson(): void
    {
        try {
            (new JsonFileCategoryHydrator())->hydrate(__DIR__ . '/fixtures/invalid-json.json');
    ...
    {
        try {
            (new JsonFileCategoryHydrator())->hydrate(__DIR__ . '/fixtures/invalid-structure.json');
    ...
    {
        try {
            (new JsonFileCategoryHydrator())->hydrate(__DIR__ . '/fixtures/invalid-domain-value.json');
            self::fail('Expected invalid structure exception was not thrown.');
        } catch (CategoryDataStructureIsInvalid $exception) {
